      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-3">
            <Button variant="outline" className="w-full h-12 text-lg" onClick={handleLogin}>
              <GoogleIcon />
              <span className="ml-2">Google 계정으로 시작</span>
            </Button>
            <Button variant="outline" className="w-full h-12 text-lg bg-[#FEE500] hover:bg-[#FEE500]/90 text-[#3C1E1E]" onClick={handleLogin}>
              <KakaoIcon />
